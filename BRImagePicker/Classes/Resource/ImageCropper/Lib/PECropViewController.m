...
+ (NSBundle *)bundle
{
    ...
    dispatch_once(&onceToken, ^{
         bundle = [NSBundle bundleWithPath:[[NSBundle bundleForClass:self] pathForResource:@"BRImagePicker" ofType:@"bundle"]];
        
//        NSURL *bundleURL = [[NSBundle mainBundle] URLForResource:@"BRImagePicker" withExtension:@"bundle"];
